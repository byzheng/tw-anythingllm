    ...
    MyWidget.prototype.render = function (parent, nextSibling) {
        ...
        if (host === undefined) {
            ...
            try {
                ...
                var llm = new anythingllm.AnythingLLM(apikey.fields.text, host.fields.text);
                ...
                async function chats(workspace, thread) {
                    var resp = await llm.chats(workspace, thread);
                ...
                async function chat(workspace, thread, message) {
                    ...
                    go_bottom()
                    var resp = await llm.chat(workspace, thread, message);
                    render_chat({
                        role: "assistant",
